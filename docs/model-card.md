...
- Media intelligence: local Tesseract.js OCR with selected-language or automatic English+Hindi processing; OCR confidence is a quality signal, not a truth signal.
